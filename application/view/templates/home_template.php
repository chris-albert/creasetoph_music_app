                    ...
                    <div class="explorer_content box-flex">
                        <div class="explorer_item">
                            <div class="music_button hbox">
                                <span class="explorer_text hbox box-flex">A Life Once Lost</span>
                        ...
                        <div class="explorer_item">
                            <div class="music_button hbox">
                                <span class="explorer_text hbox box-flex">Andrew Jackson Jihad</span>
                                <div class="explorer_buttons hbox box-align-center">
                                    <div class="small_play_button">
                                        <div class="small_play_button_triangle"></div>
                                    </div>
                            ...
                            <div class="explorer_item_child">
                                <div class="explorer_item_header">
                                    <span class="explorer_text">Albums</span>
                                </div>
                                <div class="explorer_item">
                                    <div class="music_button hbox">
                                        <span class="explorer_text hbox box-flex">Can't Maintain</span>
                                        <div class="explorer_buttons hbox box-align-center">
                                            <div class="small_play_button">
                                                <div class="small_play_button_triangle"></div>
                                            </div>
                                ...
                                <div class="explorer_item">
                                    <div class="music_button hbox">
                                        <span class="explorer_text hbox box-flex">People That Can Eat People Are The Luckiest People In The World</span>
                                        <div class="explorer_buttons hbox box-align-center">
                                            <div class="small_play_button">
                                                <div class="small_play_button_triangle"></div>
                                            </div>
                                    ...
                                    <div class="explorer_item_child">
                                        <div class="explorer_item_header">
                                            <span class="explorer_text">Tracks</span>
                                        </div>
                                        <div class="explorer_item">
                                            <div class="music_button hbox">
                                                <span class="explorer_text hbox box-flex">Can't Maintain</span>
